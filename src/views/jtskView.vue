...
<template>
  <div class="container">
    ...
    <div class="game-over" v-if="gameState === -1">
      <img
        @click="start()"
        src="https://my-picture-bucket.oss-cn-hongkong.aliyuncs.com/assets/ff1d38e27e8ad7fc52e7c0ce4ff46faf.png"
      />
    </div>
...
.container {
  ...
  background: bottom / 100% 100% no-repeat
    url("https://my-picture-bucket.oss-cn-hongkong.aliyuncs.com/assets/a538f7135011a926b77eed6f72d0674c.jpeg");
  --hammerOffsetX: 35px;
  overflow: hidden;
}
...
.rabbit-home__item {
  background: bottom no-repeat
    url("https://my-picture-bucket.oss-cn-hongkong.aliyuncs.com/assets/e1e3518f6f797dd816bf91bb77cb3f8a.png");
  overflow: hidden;
}
...
@keyframes hammeredActive {
  ...
  50% {
    background: bottom / 100% 100% no-repeat
      url("https://my-picture-bucket.oss-cn-hongkong.aliyuncs.com/assets/d099b0eda8bffafcaad9ef59c451c4dc.png");
  }
  75%,
  100% {
    background: none;
